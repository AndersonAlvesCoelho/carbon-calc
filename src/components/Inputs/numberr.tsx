...
export default function InputNumber({ label, name, errors, control, ...props }: InputProps) {
    ...
    <Controller
      ...
      render={({ field: { onChange, value } }) => (
        <div className="flex flex-col gap-1  w-full ">
          ...
          <input onChange={(evt) => onChange(Number(evt.target.value))} value={value} type="number" {...props}
